...
# Deployment
This project has been deployed via Vercel (for the frontend) and Render (for the backend). For Render, I selected the free plan which sleeps after 15 minutes of website inactivity and requires manual redeployment. So, if you wish to test the website for yourself, let me know. Or I will just redeploy every 15 minutes for the rest of my life. Or pay for a better plan, we'll see.

# Other notes
This is my first project using React and it's awesome! I hope this project reflects how cool React is.
