...
const MembershipOfCommittee = ({ onSaved, existingData, hideButtons = false, mode = 'draft', externalSubmitRef, readOnly = false }) => {
            ...
            <form className='form-container' onSubmit={handleSubmit((data) => onSubmit(data, 'draft'))}>
                <fieldset disabled={readOnly} style={{ border: 'none', padding: 0, margin: 0 }}>
                    ...
                    <div className='form-group'>
                        ...
                        <input placeholder='Board name' {...register('committeeName')} />
...
export default MembershipOfCommittee